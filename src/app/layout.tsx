...
export const metadata: Metadata = {
  ...
  description:
    "Ahmedabad's first kiosk serving Crêpes, NY Supreme Rolls & French Toast. Premium dessert destination on Sindhu Bhavan Road. Open 6 PM – 12:30 AM.",
    keywords: [
    ...
    "ny rolls ahmedabad",
    "supreme nutella roll",
    "brioche toast platter",
    "dessert near me",
    "cafe ahmedabad",
    "late night dessert ahmedabad",
