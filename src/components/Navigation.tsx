          ...
          <nav className="hidden lg:flex items-center gap-8">
            {navLinks.map((link) => (
              <button
                ...
                className={cn(
                  "text-sm font-dm tracking-wide transition-all duration-300 relative group",
              ...
              >
                ...
                <span
                  className={cn(
                    "absolute -bottom-1 left-0 h-[1.5px] bg-gold transition-all duration-300",
          ...
          <div className="hidden lg:flex items-center gap-4">
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1 text-sm text-foreground/60 hover:text-foreground transition-colors font-dm"
              >
                <Globe size={16} />
              ...
              <AnimatePresence>
                {showLangMenu && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -8 }}
                    className="absolute right-0 top-full mt-2 bg-white rounded-xl shadow-lg border border-cream-dark overflow-hidden"
                  >
                    {(["en", "hi", "gu"] as const).map((l) => (
                      <button
                        ...
                        className={cn(
                          "block w-full px-4 py-2 text-sm text-left font-dm hover:bg-cream transition-colors",
            ...
            <a
              href="/reservation"
              className="flex items-center gap-2 bg-charcoal text-white px-5 py-2.5 rounded-full text-sm font-dm hover:bg-gold transition-all duration-300 hover:scale-[1.02]"
            >
              <Calendar size={16} />
              Reserve
            </a>
